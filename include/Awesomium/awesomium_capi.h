/**
 * @file awesomium_capi.h
 *
 * The main header for the Awesomium C API.
 *
 * @author
 *
...
#ifndef __AWESOMIUM_CAPI_H__
#define __AWESOMIUM_CAPI_H__
 ...
 */
_OSMExport awe_string* awe_string_create_from_ascii(const char* str,
													size_t len);
 ...
 * @param	len	The length of the string
 */
_OSMExport awe_string* awe_string_create_from_wide(const wchar_t* str,
												   size_t len);
 ...
 * @param	len	The length of the string.
 */
_OSMExport awe_string* awe_string_create_from_utf8(const char* str,
												   size_t len);
 ...
 * @param	len	The length of the string.
 */
_OSMExport awe_string* awe_string_create_from_utf16(const wchar16* str,
												   size_t len);
 ...
 *			convert the string.
 */
_OSMExport int awe_string_to_wide(const awe_string* str,
								  wchar_t* dest, 
								  size_t len);
 ...
 *			convert the string.
 */
_OSMExport int awe_string_to_utf8(const awe_string* str,
								  char* dest, 
								  size_t len);
 ...
 */
_OSMExport void awe_webcore_initialize_default();
 ...
 */
_OSMExport awe_webview* awe_webcore_create_webview(int width, int height, 
												   bool view_source);
 ...
 */
_OSMExport void awe_webcore_set_custom_response_page(int status_code,
 ...
 *          otherwise.
 */
_OSMExport bool awe_webcore_set_cookie(const awe_string* url,
 ...
 */
_OSMExport const awe_string* awe_webcore_get_cookies(const awe_string* url,
 ...
 */
_OSMExport void awe_webcore_delete_cookie(const awe_string* url,
 ...
 */
_OSMExport void awe_webview_go_to_history_offset(awe_webview* webview,
												 int offset);
 ...
 */
_OSMExport void awe_webview_create_object(awe_webview* webview,
 ...
 */
_OSMExport void awe_webview_destroy_object(awe_webview* webview,
										   const awe_string* object_name);
 ...
 *              the WebView).
 */
_OSMExport void awe_webview_inject_mouse_move(awe_webview* webview,
											  int x,
											  int y);
 ...
 */
_OSMExport void awe_webview_inject_mouse_down(awe_webview* webview,
 ...
 */
_OSMExport void awe_webview_inject_mouse_up(awe_webview* webview,
											awe_mousebutton button);
 ...
 *							is from 10% to 500%.
 */
_OSMExport void awe_webview_set_zoom(awe_webview* webview,
									 int zoom_percent);
...
_OSMExport int awe_webview_get_zoom_for_host(awe_webview* webview,
 ...
 */
_OSMExport bool awe_webview_resize(awe_webview* webview,
								   int width,
								   int height,
 ...
 */
_OSMExport void awe_webview_set_url_filtering_mode(awe_webview* webview,
 ...
 */
_OSMExport void awe_webview_add_url_filter(awe_webview* webview,
 ...
 */
_OSMExport void awe_webview_choose_file(awe_webview* webview,
										const awe_string* file_path);
 ...
 */
_OSMExport void awe_webview_request_scroll_data(awe_webview* webview,
												const awe_string* frame_name);
 ...
 */
_OSMExport void awe_webview_stop_find(awe_webview* webview,
 ...
 */
_OSMExport void awe_webview_activate_ime(awe_webview* webview,
										 bool activate);
...
/**
 * Assigned a callback function to be notified whenever we receive
...
/**
 * Assigned a callback function to be notified whenever the user does 
 ...
 */
_OSMExport awe_jsarray* awe_jsarray_create(const awe_jsvalue** jsvalue_array, 
										   size_t length);
 ...
 */
_OSMExport const awe_jsvalue* awe_jsarray_get_element(const awe_jsarray* jsarray,
													   size_t index);
 ...
 */
_OSMExport const unsigned char* awe_renderbuffer_get_buffer(
